            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarCursos">
                        <li><a class="dropdown-item" href="curso_1.php">Curso 1</a></li>
                        <li><a class="dropdown-item" href="curso_2.php">Curso 2</a></li>
                        <li><a class="dropdown-item" href="curso_3.php">Curso 3</a></li>
                    </ul>
                </li>
                <li class="nav-item">
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1 class="text-center mt-5">Bem-vindo à nossa escola!</h1>
        </div>
    </div>
</div>
